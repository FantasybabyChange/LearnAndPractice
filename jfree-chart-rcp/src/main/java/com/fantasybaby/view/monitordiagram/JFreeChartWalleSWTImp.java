...
public class JFreeChartWalleSWTImp implements IDiagramJFreeChart{
	...
	public JFreeChart createLineChart() {
         ...
         String series = "血糖值";  
          ...
          for (int i = 0; i < 15; i++) {
                 ...
                 linedataset.setValue(i + i * 9.34 + r.nextLong() % 100,  
                		 	series,  
              time[i]); 
          }
...
//              rangeAxis.setAutoRange(false);
	...
	public JFreeChart createPieChart() {
	    ...
	    JFreeChart chart = ChartFactory.createPieChart("", defaultpiedataset, true,
	        true, true);
	    // 设置图片的背景色
